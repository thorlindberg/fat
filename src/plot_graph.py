...
def plot_graph(title, weights, predictions, increases, decreases, days, labels, output):
    ...
    plt.plot(days, p_weights(days), "--", label='Weight', color='blue')
    ...
    plt.plot(days, p_predictions(days), "--", label='Expected weight loss', color='orange')
    ...
    plt.plot(days, p_increases(days), "--", label='500 kcal increase', color='red')
    ...
    plt.plot(days, p_decreases(days), "--", label='500 kcal decrease',  color='green')
